...
const SignUp = () => {
    ...
    return (
        ...
        >
            <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled" bounces={false} showsVerticalScrollIndicator={false}>
                ...
                <CustomButton text={t('auth.signUp')} onPress={handleSignUp} style={styles.signUpButton} textStyle={styles.signUpButtonText} />
                ...
                <CustomText style={styles.loginText}>
                    {t('auth.alreadyHaveAccount')} <CustomText style={styles.loginLink} onPress={() => router.push('/sign-in')}>{t('auth.logIn')}</CustomText>
                </CustomText>
            </ScrollView>
        </KeyboardAvoidingView>
    );
